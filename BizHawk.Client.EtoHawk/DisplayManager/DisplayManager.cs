...
namespace BizHawk.Client.EtoHawk
{
	...
	public class DisplayManager : IDisposable
	{
		...
		public DisplayManager(PresentationPanel presentationPanel)
		{
            ...
            /*using (var xml = typeof(MainForm).Assembly.GetManifestResourceStream("BizHawk.Client.EmuHawk.Resources.courier16px.fnt"))
            using (var tex = typeof(MainForm).Assembly.GetManifestResourceStream("BizHawk.Client.EmuHawk.Resources.courier16px_0.png"))
		...
		EtoGraphicsControl GraphicsControl; //well, its the final layer's target, at least
		...
		/// </summary>
        public Eto.Drawing.Padding GameExtraPadding;
		...
		/// </summary>
        public Eto.Drawing.Padding ClientExtraPadding;

		/// <summary>
		/// custom fonts that don't need to be installed on the user side
		/// </summary>
		//public Eto.Drawing.Text.PrivateFontCollection CustomFonts = new System.Drawing.Text.PrivateFontCollection();
        ...
        Eto.Drawing.Padding CalculateCompleteContentPadding(bool user, bool source)
		{
            var padding = new Eto.Drawing.Padding();
		...
		public PointF UntransformPoint(PointF p)
		{
			...
			p = presentationPanel.Control.PointFromScreen(p);
		...
		public void Blank()
		{
            ...
            GL.SetClearColor(Colors.Black.ToArgb());
		...
		EtoGraphicsControl LastVsyncSettingGraphicsControl;
		...
		class MyBlitter : IBlitter
		{
			...
			{
                return new SizeF(50f, 50f); //Todo: Implementation compatible with Eto
				/*var stringRenderer = ((FontWrapper)font).font;
